...
main() 
 { 
  clrscr(); 
unsignedint sum,add,d,i,j,e,f,g,h,k,l,w,x,y,z; 
unsignedint bir=10,per=36,der=110,mur=8,par=110,cor=90,twr=1199, lur=17,tir=107, 
        rer=1499; 
int 
qubis=1000,abis=0,qupep=1000,apep=0,quden=110,aden=0,qumun=1000,amun=0,qu 
 
 
53 
  
 
perk=500,aperk=0,qucoc=400,acoc=0,qutit=100,atit=0,qulux=1000,alux=0,qutid=100
0,atid=0,quree=300,aree=0; 
...
PERFUME"<<setw(26)<<q<<setw(28)<<"Rs."<<q*par; 
 if(r>0) 
     cout<<"\n\nCOCONUT HAIR 
OIL"<<setw(29)<<r<<setw(28)<<"Rs."<<r*cor; 
 if(s>0) 
